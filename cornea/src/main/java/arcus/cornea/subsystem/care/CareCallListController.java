...
public class CareCallListController extends CallListController {
    private static final CareCallListController INSTANCE;

    static {
        INSTANCE = new CareCallListController(
    ...
    CareCallListController(ModelSource<SubsystemModel> subsystem, AddressableListSource<PersonModel> persons) {
        super(
                subsystem,
                persons,
