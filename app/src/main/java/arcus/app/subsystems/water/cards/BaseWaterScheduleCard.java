...
public class BaseWaterScheduleCard extends SimpleDividerCard {
    public final static String TAG = "BaseWaterScheduleCard";
    private String leftText;
    private String rightText;
    private int mDrawableResource;
    private ScheduledSetPoint scheduledSetPoint;

    public BaseWaterScheduleCard(Context context) {
        super(context);
        super.setTag(TAG);
        showDivider();
    }
