...
import arcus.app.subsystems.water.WaterValveScheduleEventAdapter;

import java.util.List;
import java.util.Set;

public class WaterValveWeeklyScheduleFragment extends AbstractWeeklySchedulerFragment implements WaterValveScheduleViewController.Callback {
    ...
    public static WaterValveWeeklyScheduleFragment newInstance (String deviceAddress, String deviceName) {
        WaterValveWeeklyScheduleFragment instance = new WaterValveWeeklyScheduleFragment();
    ...
    public void onResume() {
        ...
        WaterValveScheduleViewController.instance().select(getScheduledEntityAddress(), this, getSelectedDayOfWeek());
    ...
    public void onAddCommand() {
        BackstackManager.getInstance()
                .navigateToFragment(WaterValveCommandEditorFragment.newAddEventInstance(getDeviceAddress(), getDeviceName(), getSelectedDayOfWeek()), true);
    }
    ...
    public void onEditCommand(Object command) {
        ...
        BackstackManager.getInstance()
                .navigateToFragment(WaterValveCommandEditorFragment
                       .newEditEventInstance(getDeviceAddress(), getDeviceName(), timeOfDayCommandId, getSelectedDayOfWeek()), true);
    }
    ...
    public void showSchedule(@NonNull DayOfWeek selectedDay, @NonNull Set<DayOfWeek> daysWithSchedule, @NonNull List<WaterScheduleDay> events) {
        ...
        setScheduledCommandsAdapter(new WaterValveScheduleEventAdapter(getActivity(), events));
    }
