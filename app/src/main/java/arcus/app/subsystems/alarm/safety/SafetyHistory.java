...
public class SafetyHistory extends BaseFragment implements SafetyHistoryController.Callback {
    ...
    public static SafetyHistory newInstance() {
        return new SafetyHistory();
    }
    ...
    public void onResume() {
        super.onResume();
        historyLogCallbackRef = SafetyHistoryController.instance().setCallback(this);
        showProgressBar();
    }

    @Override
    public void onShowSafetyHistory(HistoryLogEntries entries) {
