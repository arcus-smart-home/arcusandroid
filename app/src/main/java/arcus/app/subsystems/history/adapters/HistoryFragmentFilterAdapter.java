...
import arcus.app.R;
import arcus.app.subsystems.history.model.HistoryFilter;
...
public class HistoryFragmentFilterAdapter extends ArrayAdapter<HistoryFilter> {
    ...
    public HistoryFragmentFilterAdapter(Context context, @NonNull List<HistoryFilter> options, HistoryFilter checked) {
