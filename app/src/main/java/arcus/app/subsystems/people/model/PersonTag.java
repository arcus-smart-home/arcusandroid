...
public enum PersonTag implements Localizable {

    SPOUSE(R.string.people_spouse),
    PARENT(R.string.people_parent),
    CHILD(R.string.people_child),
