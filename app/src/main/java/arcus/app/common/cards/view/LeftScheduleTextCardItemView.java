...
public class LeftScheduleTextCardItemView extends BaseCardItemView<LeftScheduleTextCard> {
    ...
    public LeftScheduleTextCardItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LeftScheduleTextCardItemView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void showScheduleIcon(LeftScheduleTextCard card) {
        if (card.isSchedIconShown())
            mImageViewSched.setVisibility(VISIBLE);
        else
            mImageViewSched.setVisibility(GONE);

    }

    public void checkRadioButton(LeftScheduleTextCard card) {
    ...
    private void setResourceImageToView(@NonNull LeftScheduleTextCard card) {
    ...
    private void setDeviceImageToView(@NonNull LeftScheduleTextCard card) {
    ...
    private void setPersonImageToView(@NonNull LeftScheduleTextCard card) {
        if (card.getModelID() == null) {
            hideImageView();
            return;
        }
    ...
    private void setPlaceImageToView(@NonNull LeftScheduleTextCard card) {
        if (card.getModelID() == null) {
            hideImageView();
            return;
        }
