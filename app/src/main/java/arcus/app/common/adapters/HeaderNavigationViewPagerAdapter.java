...
public class HeaderNavigationViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public HeaderNavigationViewPagerAdapter(Context context, FragmentManager fm, List<Fragment> fragments, String[] tabTitles) {
        super(fm);
