...
public class LutronDeviceDeletedFragment extends FullScreenErrorFragment {
    ...
    public String getErrorTitle() {
        return getString(R.string.lutron_device_deleted_fragment_title);
    }

    @Override
    public int getBodyLayoutId() {
        return R.layout.fragment_lutron_device_deleted;
    }
