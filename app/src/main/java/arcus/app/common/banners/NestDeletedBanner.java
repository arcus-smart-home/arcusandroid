...
import arcus.app.common.error.fragment.NestDeletedFragment;



public class NestDeletedBanner extends ClickableBanner {

    public NestDeletedBanner(final String revokedDeviceAddress) {
        super(R.layout.banner_nest_deleted);

        setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FullscreenFragmentActivity.launch(getActivity(), NestDeletedFragment.class);
            }
        });
    }
}
