...
public class GenericMaterialListView extends RecyclerView {
    ...
    public GenericMaterialListView(Context context) {
        this(context, null);
    }

    public GenericMaterialListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GenericMaterialListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addOnItemTouchListener(RecyclerItemGenericListener.OnItemClickListener listener){

        RecyclerItemGenericListener itemClickListener = new RecyclerItemGenericListener(getContext(), listener);
