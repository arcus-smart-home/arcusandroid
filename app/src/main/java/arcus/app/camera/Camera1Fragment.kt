...
import arcus.presentation.camera.Camera1PresenterImpl
import arcus.presentation.camera.CameraView
import java.io.File

class Camera1Fragment : CameraFragment(), CameraView {
    private lateinit var presenter : Camera1PresenterImpl
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let {
            presenter = Camera1PresenterImpl(it, getTextureView())
        }
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Camera1Fragment()
    }
}