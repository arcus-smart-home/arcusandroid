...
class ZWaveRebuildLaterFragment : Fragment(),
    TitledFragment {
    private lateinit var mCallback: FragmentFlow

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        logger.info("ZWave Rebuild Later")
        return inflater.inflate(R.layout.fragment_zwave_rebuild_later, container, false)
    }
    ...
    companion object {
        ...
        @JvmStatic
        private val logger = LoggerFactory.getLogger(ZWaveRebuildLaterFragment::class.java)

        @JvmStatic
        fun newInstance() =
            ZWaveRebuildLaterFragment()
    }
}
