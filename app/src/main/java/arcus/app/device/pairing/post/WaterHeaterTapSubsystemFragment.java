...
public class WaterHeaterTapSubsystemFragment extends SequencedFragment {

    private Version1Button nextButton;

    public static WaterHeaterTapSubsystemFragment newInstance () {
        return new WaterHeaterTapSubsystemFragment();
    }
    ...
    public Integer getLayoutId() {
        return R.layout.fragment_water_heater_postpairing;
    }
