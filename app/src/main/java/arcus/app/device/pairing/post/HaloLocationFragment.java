...
public class HaloLocationFragment extends SequencedFragment<HaloPlusPairingSequenceController> implements HaloController.Callback, LocationPopup.Callback, HaloController.LocationCallback {
    ...
    public void onResume () {
        ...
        skipSetupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                getController().skipToEnd(getActivity());
                //BackstackManager.getInstance().navigateToFragment(AddToFavoritesFragment.newInstance(deviceAddress), true);
            }
        });
