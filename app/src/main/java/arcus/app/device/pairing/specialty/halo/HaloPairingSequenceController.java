...
public class HaloPairingSequenceController extends AbstractSequenceController {

    private Sequenceable previousSequence;
    private final String deviceAddress;

    public HaloPairingSequenceController(Sequenceable from, String deviceAddress) {
