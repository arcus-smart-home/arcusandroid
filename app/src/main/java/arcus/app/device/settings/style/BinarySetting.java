...
/**
 * A representation of a binary (on/off) setting.
 */
public class BinarySetting extends AbstractSetting implements Setting {

    private boolean currentState;

    public BinarySetting (String title, String description, boolean initialState) {
        super(title, description, R.layout.setting_binary);
