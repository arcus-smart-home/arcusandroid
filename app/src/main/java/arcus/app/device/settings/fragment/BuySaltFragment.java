...
public class BuySaltFragment extends SequencedFragment {
    ...
    public static BuySaltFragment newInstance(){
        BuySaltFragment fragment = new BuySaltFragment();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        buyBtn = (Version1Button) view.findViewById(R.id.fragment_buy_salt_btn);
        buyBtn.setColorScheme(Version1ButtonColor.WHITE);
        buyBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(GlobalSetting.WHAT_SALT_SHOULD_USE_URL)));
            }
        });
        return view;
    }
    ...
    public Integer getLayoutId() {
        return R.layout.fragment_buy_salt;
    }
}
