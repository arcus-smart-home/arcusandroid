...
class CreateAccountSuccessFragment : Fragment() {
    ...
    ): View? = container?.inflate(R.layout.fragment_account_creation_success)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        view.findViewById<View>(R.id.next).setOnClickListener {
            BackstackManager.getInstance()
                    .navigateToFragment(HaveAHubFragment.newInstance(), true)
        }
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance(): CreateAccountSuccessFragment = CreateAccountSuccessFragment()
    }
}
