...
public class CareBehaviorTemplateProviderTest extends MockClientTestCase {
    static final String CARE_ADDRESS = "SERV:subcare:2e37d90f-a1df-491f-b5f2-242f4f4833c4";

    CareBehaviorTemplateProvider provider;

    @Before public void setUp() throws Exception {
        provider = new CareBehaviorTemplateProvider();
    }

    @Test public void testNormalLoad() throws Exception {
        baseWithBehaviorTemplates();
    }
    ...
    protected void baseWithBehaviorTemplates() throws Exception {
