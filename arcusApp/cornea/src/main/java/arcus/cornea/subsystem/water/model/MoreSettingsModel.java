...
public class MoreSettingsModel {
    private List<WaterHeaterSettingsModel> waterheaters;
    private DeviceSettingsModel dashboardTemperature;
    private DeviceSettingsModel dashboardHumidity;

    public List<WaterHeaterSettingsModel> getWaterHeaters() {
        return waterheaters;
    }

    public void setWaterHeaters(List<WaterHeaterSettingsModel> waterheaters) {
