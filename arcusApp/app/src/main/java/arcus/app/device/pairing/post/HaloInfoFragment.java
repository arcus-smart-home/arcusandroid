...
public class HaloInfoFragment extends SequencedFragment {

    public static HaloInfoFragment newInstance() {
        return new HaloInfoFragment();
    }
    ...
    @Override public Integer getLayoutId() {
        return R.layout.fragment_halo_postpairing_info;
    }
}
