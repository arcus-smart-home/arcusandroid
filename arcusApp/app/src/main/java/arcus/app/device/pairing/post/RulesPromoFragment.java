...
public class RulesPromoFragment extends SequencedFragment<PostPairingSequenceController> {

    private Version1Button nextButton;

    public static RulesPromoFragment newInstance () {
        return new RulesPromoFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = super.onCreateView(inflater, container, savedInstanceState);
        nextButton = (Version1Button) view.findViewById(R.id.pairsRulesNextBtn);
        return view;
    }
    ...
    public Integer getLayoutId() {
        return R.layout.fragment_device_pairs_rules;
    }
}
