 ...
 * alternative is via the {@link arcus.app.common.view.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * {@link #setCustomTabColorizer(arcus.app.common.view.SlidingTabLayout.TabColorizer)}.
     */
    ...
    public interface TabClickCallback {
        boolean enableTabClick(int position);
    }
    ...
    public SlidingTabLayout(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayout(@NonNull Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Set the custom {@link arcus.app.common.view.SlidingTabLayout.TabColorizer} to be used.
     *
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link arcus.app.common.view.SlidingTabLayout} you are
     ...
     */
    @NonNull
    protected Version1TextView createDefaultTabView(@NonNull Context context) {
        WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        Display display = wm.getDefaultDisplay();
        Point size = new Point();
        display.getSize(size);

        Version1TextView textView = new Version1TextView(context);
        textView.setGravity(Gravity.CENTER);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP);
        textView.setTypeface(FontUtils.getDemi(context));
    ...
    public void enableMoreTab(boolean enable) {
        View view = mTabStrip.getChildAt(1);
        if (view == null) {
            return;
        }
        ...
        public void onClick(View v) {
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if (v == mTabStrip.getChildAt(i)) {
                    if (callback == null || callback.enableTabClick(i)) {
