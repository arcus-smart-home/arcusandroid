...
public class NestCredentialsRevokedFragment extends FullScreenErrorFragment {
    ...
    public String getErrorTitle() {
        return getString(R.string.nest_account_revoked_title);
    }

    @Override
    public int getBodyLayoutId() {
        return R.layout.fragment_nest_account_revoked;
    }
