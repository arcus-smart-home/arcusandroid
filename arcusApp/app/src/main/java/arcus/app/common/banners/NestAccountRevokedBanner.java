...
import arcus.app.common.error.fragment.NestCredentialsRevokedFragment;



public class NestAccountRevokedBanner extends ClickableBanner {

    public NestAccountRevokedBanner(final String revokedDeviceAddress) {
        super(R.layout.banner_account_revoked);

        setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FullscreenFragmentActivity.launch(getActivity(), NestCredentialsRevokedFragment.class);
            }
        });
    }
}
