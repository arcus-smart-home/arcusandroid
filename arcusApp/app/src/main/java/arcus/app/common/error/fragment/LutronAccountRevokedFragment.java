...
public class LutronAccountRevokedFragment extends FullScreenErrorFragment {
    ...
    public String getErrorTitle() {
        return getString(R.string.lutron_account_revoked_fragment_title);
    }

    @Override
    public int getBodyLayoutId() {
        return R.layout.fragment_lutron_account_revoked;
    }
