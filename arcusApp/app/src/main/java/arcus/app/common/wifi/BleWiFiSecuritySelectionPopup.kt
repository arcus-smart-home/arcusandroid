...
class BleWiFiSecuritySelectionPopup : ScleraSelectionPopup<DeviceWiFiNetworkSecurity>() {
    private val choices = DeviceWiFiNetworkSecurity.getAvailableBleChoices().toTypedArray()
    ...
    companion object {
        ...
        ) = BleWiFiSecuritySelectionPopup().also {
