...
public class MultipleErrorsFullBanner extends ClickableBanner{
    public MultipleErrorsFullBanner(int viewResourceId) {
        super(R.layout.multiple_errors_full_banner);
    }
